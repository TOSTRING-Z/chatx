...
async function chatBase(queryText, prompt=null, version, method) {
    try {
        ...
        const response = await axios.post(get_api_url(method), {
            'model': version,
            'messages': messages_list,
        }, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${get_api_key(method)}`,
            },
        });
